...
//    }
     ...
     * @return
     */
    public static EmallResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
     ...
     * @return
     */
    public static EmallResult format(String json) {
        try {
            return MAPPER.readValue(json, EmallResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
